...
class MensCategory extends ConsumerWidget {
  const MensCategory({super.key});
                        ...
                        child: GridView.builder(
                          ...
                          gridDelegate:
                              SliverGridDelegateWithFixedCrossAxisCount(
                                  mainAxisExtent: context.width(
                                    216,
                                  ),
                                  mainAxisSpacing: context.width(
                                    18,
                                  ),
